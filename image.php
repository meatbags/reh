...
get_header(); ?>
			...
			<div id="content" class="clearfix row">
				...
				<div id="main" class="sm-8 clearfix">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> itemscope itemtype="http://schema.org/BlogPosting">
						...
						<header>
							...
							<h1 itemprop="headline"><a href="<?php echo get_permalink($post->post_parent); ?>" rev="attachment"><?php echo get_the_title($post->post_parent); ?></a> &raquo; <?php the_title(); ?></h1>
				...
				<div id="sidebar1" class="col lg-4 fluid-sidebar sidebar">
