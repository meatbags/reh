...
function wp_bootstrap_excerpt_more($more) {
	...
	//return '...  <a href="'. get_permalink($post->ID) . '" class="more-link" title="Read '.get_the_title($post->ID).'"></a>';
	return '...';
}
...
function page_navi($before = '', $after = '') {
	...
	if ($paged > 1) {
		...
		//echo '<li class="prev"><a class="button" href="'.get_pagenum_link().'" title="First">'.$first_page_text.'</a></li>';
	}

	$prevposts = get_previous_posts_link('Previous page');
	if($prevposts) { echo '<li>' . $prevposts  . '</li>'; }
	//else { echo '<li><a class="button" href="#">Previous page</a></li>'; }

	//for($i = $start_page; $i  <= $end_page; $i++) {
		//if($i == $paged) {
			//echo '<li class="active"><a class="button" href="#">'.$i.'</a></li>';
		//} else {
			//echo '<li><a class="button" href="'.get_pagenum_link($i).'">'.$i.'</a></li>';
		//}
	//}
	...
	if ($end_page < $max_page) {
		...
		//echo '<li class="next"><a class="button" href="'.get_pagenum_link($max_page).'" title="Last">'.$last_page_text.'</a></li>';
	}
	echo '</ul></div>'.$after."";
}
